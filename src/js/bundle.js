...
function cards(cardsSelector) {
  var menuContainer = document.querySelector(cardsSelector);
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_4__.getResourse)('http://localhost:3000/menu').then(function (data) {
...
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modal */ "./src/js/modules/modal.js");
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../services/services */ "./src/js/services/services.js");
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", function (e) {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_12__.postData)("http://localhost:3000/requests", json).then(function () {
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_11__.openModal)('.modal', modalTimerId);
...
/* harmony export */   "calcScrollbarWidth": () => (/* binding */ calcScrollbarWidth)
/* harmony export */ });
/* harmony import */ var core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.for-each.js */ "./node_modules/core-js/modules/es.array.for-each.js");
/* harmony import */ var core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
...
function openModal(modalSelector, modalTimerId) {
  ...
  document.body.style.cssText = "overflow:hidden; \n    padding-right:".concat(calcScrollbarWidth(), "px;");
...
function slider(_ref) {
  ...
  var slider = document.querySelector(container),
      ...
      width = sliderWrapper.offsetWidth; // create slider's navbar
  ...
  sliderInnerWrapper.style.cssText = "width: ".concat(100 * slides.length, "%;\n  display:flex; transition:0.5s all;");
  sliderWrapper.style.overflow = "hidden";
  var offset = 0,
      currentSlide = 0; // the number of the current slide from 0

  totalNumder.textContent = "0".concat(slides.length);
  setSlider();
  ...
  navbar.addEventListener("click", function (e) {
    if (e.target && e.target.classList.contains("dot")) {
      navbarElements.forEach(function (navelem, i) {
        if (e.target == navelem) {
          currentSlide = i;
          offset = width * i;
          setSlider(currentSlide, offset);
  ...
  function setSlider() {
    ...
    sliderInnerWrapper.style.transform = "translateX(-".concat(offset, "px)");
    navbarElements.forEach(function (navelem, i) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new Error("Could not fetch ".concat(url, ", status: ").concat(response.status));
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_3__.default)('[data-class]');
