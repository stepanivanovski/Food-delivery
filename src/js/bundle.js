...
function cards(cardsSelector) {
  var menu = document.querySelector(cardsSelector);

  var Menu = /*#__PURE__*/function () {
    function Menu(img, altimg, title, descr, price, parent) {
  ...
  getResourse('  http://localhost:3000/menu').then(function (data) {
...
function slider(_ref) {
  var conteiner = _ref.conteiner,
      ...
      field = _ref.field;
  var prevSlider = document.querySelector(prevArrow),
  ...
  arrIndicator.forEach(function (item, i) {
  ...
  currentNumder.textContent = "0".concat(y + 1);
  totalNumder.textContent = "0".concat(slide.length);
  ...
  function setSlider(num, offset) {
    currentNumder.textContent = "0".concat(num + 1);
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, classActive) {
  //Tabs
  var content = document.querySelectorAll(tabsContentSelector),
...
function timer(id, deadline) {
  ...
  function setClock(selector, endtime) {
    ...
    var Int = setInterval(updateTime, 1000);
    updateTime();
...
window.addEventListener("DOMContentLoaded", function () {
  var modalTimerId = setTimeout(function () {
    (0,_modules_modal__WEBPACK_IMPORTED_MODULE_4__.openModal)(modalSelector, modalTimerId);
  }, 300000);
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_1__.default)();
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_2__.default)('[data-class]');
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__.default)(".timer", "2022-05-12");
});
})();
